...
;(function($){	
	...
	function setViewEle(obj){
		...
		element += '		</div>';
		element += '	</div>';
		if(obj.btmArea.video.link.search(/http/) != 0 ){
			blk = '';
			click ='href="#" onclick';
		}
		element += '	<div class="section3">';
		element += '		<div class="video"><img src="'+obj.btmArea.video.image+'"/><a '+click+'="'+obj.btmArea.video.link+'" '+blk+' class="clt_bg">동영상 보러가기</a></div>';
